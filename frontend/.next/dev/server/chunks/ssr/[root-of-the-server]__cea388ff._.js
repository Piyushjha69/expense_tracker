...
function RegisterPage() {
    ...
    async function handleRegister(e) {
        ...
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/register", {
                method: "POST",
                body: JSON.stringify({
                    email,
                    password
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cea388ff._.js.map